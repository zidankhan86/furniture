    ...
    <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
            <ul class="breedcrumb__content">
                ...
                <li class="active"><a href="#">{{$details->name}}</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-6">
                ...
                <div class="gallery-view">
                        ...
                        <div class="swiper-container gallery-items-slider">
                            <div class="swiper-wrapper">
                                <div class="gallery-item swiper-slide">
                                    <img src="{{ asset('/public/uploads/' . $details->image) }}" alt="Slide 01" />
                                </div>
                                <div class="gallery-item swiper-slide">
                    ...
                    <div class="gallery-main-image products__gallery-img--lg">
                        <img class="product-main-image" src="{{ asset('/public/uploads/' . $details->image) }}" alt="Slide 01" />
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="products__content">
                    <div class="products__content-title">
                        <h2 class="font-title--md"> {{$details->name}}</h2>
                        
                        @if ($details->stock != 0)
                        <span class="label stock-in">in Stock</span>
                        @else
                        <span class="label stock-in" style="color: red">Stock Out</span>
                        @endif
                    ...
                    <div class="products__content-price">
                        <h2 class="font-body--xxxl-500"> {{ $details->price }}</h2>
                ...
                <div class="products__content">
                    <div class="products__content-action">
                        ...
                        <!-- add to cart  -->
                            ...
                            <a href="{{route('add.to.cart',$details->id)}}" class="btn btn-primary">ADD TO CART</a>
